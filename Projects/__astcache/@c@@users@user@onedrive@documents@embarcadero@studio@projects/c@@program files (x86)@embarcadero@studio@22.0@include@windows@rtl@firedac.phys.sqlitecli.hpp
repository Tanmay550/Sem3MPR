...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.SQLiteCli.pas' rev: 35.00 (Windows)
...
static const System::Int8 NOT_WITHIN = System::Int8(0x0);
static const System::Int8 PARTLY_WITHIN = System::Int8(0x1);
static const System::Int8 FULLY_WITHIN = System::Int8(0x2);
...
static const int SQLITE_OPEN_NOFOLLOW = int(0x1000000);
static const System::Int8 SQLITE_DENY = System::Int8(0x1);
static const System::Int8 SQLITE_IGNORE = System::Int8(0x2);
static const System::Int8 SQLITE_STATUS_MEMORY_USED = System::Int8(0x0);
static const System::Int8 SQLITE_STATUS_PAGECACHE_USED = System::Int8(0x1);
static const System::Int8 SQLITE_STATUS_PAGECACHE_OVERFLOW = System::Int8(0x2);
static const System::Int8 SQLITE_STATUS_SCRATCH_USED = System::Int8(0x3);
static const System::Int8 SQLITE_STATUS_SCRATCH_OVERFLOW = System::Int8(0x4);
static const System::Int8 SQLITE_STATUS_MALLOC_SIZE = System::Int8(0x5);
static const System::Int8 SQLITE_STATUS_PARSER_STACK = System::Int8(0x6);
static const System::Int8 SQLITE_STATUS_PAGECACHE_SIZE = System::Int8(0x7);
static const System::Int8 SQLITE_STATUS_SCRATCH_SIZE = System::Int8(0x8);
static const System::Int8 SQLITE_STATUS_MALLOC_COUNT = System::Int8(0x9);
static const System::Int8 SQLITE_DBSTATUS_LOOKASIDE_USED = System::Int8(0x0);
static const System::Int8 SQLITE_DBSTATUS_CACHE_USED = System::Int8(0x1);
static const System::Int8 SQLITE_DBSTATUS_SCHEMA_USED = System::Int8(0x2);
static const System::Int8 SQLITE_DBSTATUS_STMT_USED = System::Int8(0x3);
static const System::Int8 SQLITE_DBSTATUS_LOOKASIDE_HIT = System::Int8(0x4);
static const System::Int8 SQLITE_DBSTATUS_LOOKASIDE_MISS_SIZE = System::Int8(0x5);
static const System::Int8 SQLITE_DBSTATUS_LOOKASIDE_MISS_FULL = System::Int8(0x6);
static const System::Int8 SQLITE_DBSTATUS_CACHE_HIT = System::Int8(0x7);
static const System::Int8 SQLITE_DBSTATUS_CACHE_MISS = System::Int8(0x8);
static const System::Int8 SQLITE_DBSTATUS_CACHE_WRITE = System::Int8(0x9);
static const System::Int8 SQLITE_DBSTATUS_DEFERRED_FKS = System::Int8(0xa);
static const System::Int8 SQLITE_DBSTATUS_MAX = System::Int8(0xa);
static const System::Int8 SQLITE_STMTSTATUS_FULLSCAN_STEP = System::Int8(0x1);
static const System::Int8 SQLITE_STMTSTATUS_SORT = System::Int8(0x2);
static const System::Int8 SQLITE_STMTSTATUS_AUTOINDEX = System::Int8(0x3);
static const System::Int8 SQLITE_STMTSTATUS_VM_STEP = System::Int8(0x4);
static const System::Int8 SQLITE_STMTSTATUS_REPREPARE = System::Int8(0x5);
static const System::Int8 SQLITE_STMTSTATUS_RUN = System::Int8(0x6);
static const System::Int8 SQLITE_STMTSTATUS_MEMUSED = System::Int8(0x63);
...
static const System::Int8 SQLITE_NOTICE = System::Int8(0x1b);
static const System::Int8 SQLITE_WARNING = System::Int8(0x1c);
...
static const System::Word SQLITE_IOERR_MMAP = System::Word(0x180a);
static const System::Word SQLITE_IOERR_GETTEMPPATH = System::Word(0x190a);
static const System::Word SQLITE_IOERR_CONVPATH = System::Word(0x1a0a);
static const System::Word SQLITE_IOERR_VNODE = System::Word(0x1b0a);
...
static const System::Word SQLITE_CANTOPEN_FULLPATH = System::Word(0x30e);
static const System::Word SQLITE_CANTOPEN_CONVPATH = System::Word(0x40e);
...
static const System::Word SQLITE_READONLY_ROLLBACK = System::Word(0x308);
static const System::Word SQLITE_READONLY_DBMOVED = System::Word(0x408);
static const System::Word SQLITE_ABORT_ROLLBACK = System::Word(0x204);
static const System::Word SQLITE_CONSTRAINT_CHECK = System::Word(0x113);
static const System::Word SQLITE_CONSTRAINT_COMMITHOOK = System::Word(0x213);
static const System::Word SQLITE_CONSTRAINT_FOREIGNKEY = System::Word(0x313);
static const System::Word SQLITE_CONSTRAINT_FUNCTION = System::Word(0x413);
static const System::Word SQLITE_CONSTRAINT_NOTNULL = System::Word(0x513);
static const System::Word SQLITE_CONSTRAINT_PRIMARYKEY = System::Word(0x613);
static const System::Word SQLITE_CONSTRAINT_TRIGGER = System::Word(0x713);
static const System::Word SQLITE_CONSTRAINT_UNIQUE = System::Word(0x813);
static const System::Word SQLITE_CONSTRAINT_VTAB = System::Word(0x913);
static const System::Word SQLITE_CONSTRAINT_ROWID = System::Word(0xa13);
static const System::Word SQLITE_NOTICE_RECOVER_WAL = System::Word(0x11b);
static const System::Word SQLITE_NOTICE_RECOVER_ROLLBACK = System::Word(0x21b);
static const System::Word SQLITE_WARNING_AUTOINDEX = System::Word(0x11c);
static const System::Word SQLITE_AUTH_USER = System::Word(0x117);
static const System::Int8 SQLITE_FALSE = System::Int8(0x0);
static const System::Int8 SQLITE_TRUE = System::Int8(0x1);
...
static const System::Int8 SQLITE_CREATE_INDEX = System::Int8(0x1);
static const System::Int8 SQLITE_CREATE_TABLE = System::Int8(0x2);
static const System::Int8 SQLITE_CREATE_TEMP_INDEX = System::Int8(0x3);
static const System::Int8 SQLITE_CREATE_TEMP_TABLE = System::Int8(0x4);
static const System::Int8 SQLITE_CREATE_TEMP_TRIGGER = System::Int8(0x5);
static const System::Int8 SQLITE_CREATE_TEMP_VIEW = System::Int8(0x6);
static const System::Int8 SQLITE_CREATE_TRIGGER = System::Int8(0x7);
static const System::Int8 SQLITE_CREATE_VIEW = System::Int8(0x8);
static const System::Int8 SQLITE_DELETE = System::Int8(0x9);
static const System::Int8 SQLITE_DROP_INDEX = System::Int8(0xa);
static const System::Int8 SQLITE_DROP_TABLE = System::Int8(0xb);
static const System::Int8 SQLITE_DROP_TEMP_INDEX = System::Int8(0xc);
static const System::Int8 SQLITE_DROP_TEMP_TABLE = System::Int8(0xd);
static const System::Int8 SQLITE_DROP_TEMP_TRIGGER = System::Int8(0xe);
static const System::Int8 SQLITE_DROP_TEMP_VIEW = System::Int8(0xf);
static const System::Int8 SQLITE_DROP_TRIGGER = System::Int8(0x10);
static const System::Int8 SQLITE_DROP_VIEW = System::Int8(0x11);
static const System::Int8 SQLITE_INSERT = System::Int8(0x12);
static const System::Int8 SQLITE_PRAGMA = System::Int8(0x13);
static const System::Int8 SQLITE_READ = System::Int8(0x14);
static const System::Int8 SQLITE_SELECT = System::Int8(0x15);
static const System::Int8 SQLITE_TRANSACTION = System::Int8(0x16);
static const System::Int8 SQLITE_UPDATE = System::Int8(0x17);
static const System::Int8 SQLITE_ATTACH = System::Int8(0x18);
static const System::Int8 SQLITE_DETACH = System::Int8(0x19);
static const System::Int8 SQLITE_ALTER_TABLE = System::Int8(0x1a);
static const System::Int8 SQLITE_REINDEX = System::Int8(0x1b);
static const System::Int8 SQLITE_ANALYZE = System::Int8(0x1c);
static const System::Int8 SQLITE_CREATE_VTABLE = System::Int8(0x1d);
static const System::Int8 SQLITE_DROP_VTABLE = System::Int8(0x1e);
static const System::Int8 SQLITE_FUNCTION = System::Int8(0x1f);
static const System::Int8 SQLITE_SAVEPOINT = System::Int8(0x20);
static const System::Int8 SQLITE_COPY = System::Int8(0x0);
static const System::Int8 SQLITE_RECURSIVE = System::Int8(0x21);
static const System::Int8 SQLITE_CONFIG_SINGLETHREAD = System::Int8(0x1);
static const System::Int8 SQLITE_CONFIG_MULTITHREAD = System::Int8(0x2);
static const System::Int8 SQLITE_CONFIG_SERIALIZED = System::Int8(0x3);
static const System::Int8 SQLITE_CONFIG_MALLOC = System::Int8(0x4);
static const System::Int8 SQLITE_CONFIG_GETMALLOC = System::Int8(0x5);
static const System::Int8 SQLITE_CONFIG_SCRATCH = System::Int8(0x6);
static const System::Int8 SQLITE_CONFIG_PAGECACHE = System::Int8(0x7);
static const System::Int8 SQLITE_CONFIG_HEAP = System::Int8(0x8);
static const System::Int8 SQLITE_CONFIG_MEMSTATUS = System::Int8(0x9);
static const System::Int8 SQLITE_CONFIG_MUTEX = System::Int8(0xa);
static const System::Int8 SQLITE_CONFIG_GETMUTEX = System::Int8(0xb);
static const System::Int8 SQLITE_CONFIG_CHUNKALLOC = System::Int8(0xc);
static const System::Int8 SQLITE_CONFIG_PCACHE = System::Int8(0xe);
static const System::Int8 SQLITE_CONFIG_GETPCACHE = System::Int8(0xf);
static const System::Int8 SQLITE_CONFIG_LOG = System::Int8(0x10);
static const System::Int8 SQLITE_CONFIG_URI = System::Int8(0x11);
static const System::Int8 SQLITE_CONFIG_PCACHE2 = System::Int8(0x12);
static const System::Int8 SQLITE_CONFIG_GETPCACHE2 = System::Int8(0x13);
static const System::Int8 SQLITE_CONFIG_COVERING_INDEX_SCAN = System::Int8(0x14);
static const System::Int8 SQLITE_CONFIG_SQLLOG = System::Int8(0x15);
static const System::Int8 SQLITE_CONFIG_MMAP_SIZE = System::Int8(0x16);
static const System::Int8 SQLITE_CONFIG_WIN32_HEAPSIZE = System::Int8(0x17);
static const System::Int8 SQLITE_CONFIG_PCACHE_HDRSZ = System::Int8(0x18);
static const System::Int8 SQLITE_CONFIG_PMASZ = System::Int8(0x19);
static const System::Word SQLITE_DBCONFIG_MAINDBNAME = System::Word(0x3e8);
static const System::Word SQLITE_DBCONFIG_LOOKASIDE = System::Word(0x3e9);
static const System::Word SQLITE_DBCONFIG_ENABLE_FKEY = System::Word(0x3ea);
static const System::Word SQLITE_DBCONFIG_ENABLE_TRIGGER = System::Word(0x3eb);
static const System::Word SQLITE_DBCONFIG_ENABLE_FTS3_TOKENIZER = System::Word(0x3ec);
static const System::Word SQLITE_DBCONFIG_ENABLE_LOAD_EXTENSION = System::Word(0x3ed);
static const System::Word SQLITE_DBCONFIG_NO_CKPT_ON_CLOSE = System::Word(0x3ee);
static const System::Word SQLITE_DBCONFIG_ENABLE_QPSG = System::Word(0x3ef);
static const System::Word SQLITE_DBCONFIG_TRIGGER_EQP = System::Word(0x3f0);
static const System::Word SQLITE_DBCONFIG_RESET_DATABASE = System::Word(0x3f1);
static const System::Word SQLITE_DBCONFIG_DEFENSIVE = System::Word(0x3f2);
static const System::Word SQLITE_DBCONFIG_WRITABLE_SCHEMA = System::Word(0x3f3);
static const System::Word SQLITE_DBCONFIG_LEGACY_ALTER_TABLE = System::Word(0x3f4);
static const System::Word SQLITE_DBCONFIG_DQS_DML = System::Word(0x3f5);
static const System::Word SQLITE_DBCONFIG_DQS_DDL = System::Word(0x3f6);
static const System::Word SQLITE_DBCONFIG_ENABLE_VIEW = System::Word(0x3f7);
static const System::Word SQLITE_DBCONFIG_LEGACY_FILE_FORMAT = System::Word(0x3f8);
static const System::Word SQLITE_DBCONFIG_TRUSTED_SCHEMA = System::Word(0x3f9);
static const System::Word SQLITE_DBCONFIG_MAX = System::Word(0x3f9);
...
static const System::Int8 SQLITE_INDEX_CONSTRAINT_NE = System::Int8(0x44);
static const System::Int8 SQLITE_INDEX_CONSTRAINT_ISNOT = System::Int8(0x45);
static const System::Int8 SQLITE_INDEX_CONSTRAINT_ISNOTNULL = System::Int8(0x46);
static const System::Int8 SQLITE_INDEX_CONSTRAINT_ISNULL = System::Int8(0x47);
static const System::Int8 SQLITE_INDEX_CONSTRAINT_IS = System::Int8(0x48);
static const System::Int8 SQLITE_INDEX_SCAN_UNIQUE = System::Int8(0x1);
static const HRESULT E_SQLITE_VTAB_RES = HRESULT(32768);
...
static const System::Int8 SQLITE_UTF16NATIVE = System::Int8(0x0);
...
static const System::Int8 SQLITE_UTF16_ALIGNED = System::Int8(0x8);
static const System::Word SQLITE_DETERMINISTIC = System::Word(0x800);
static const int SQLITE_DIRECTONLY = int(0x80000);
static const int SQLITE_SUBTYPE = int(0x100000);
static const int SQLITE_INNOCUOUS = int(0x200000);
static const System::Int8 SQLITE_VTAB_DS_ROWID_IDX = System::Int8(0x1);
static const System::Int8 SQLITE_VTAB_DS_KEY_IDX = System::Int8(0x2);
static const System::Int8 SQLITE_VTAB_DS_ORD_IDX = System::Int8(0x4);
static const System::Int8 SQLITE_VTAB_CONSTRAINT_SUPPORT = System::Int8(0x1);
static const System::Int8 SQLITE_VTAB_INNOCUOUS = System::Int8(0x2);
static const System::Int8 SQLITE_VTAB_DIRECTONLY = System::Int8(0x3);
static const System::Int8 SQLITE_ROLLBACK = System::Int8(0x1);
static const System::Int8 SQLITE_FAIL = System::Int8(0x3);
static const System::Int8 SQLITE_REPLACE = System::Int8(0x5);
}	/* namespace Sqlitecli */
}	/* namespace Phys */
}	/* namespace Firedac */
