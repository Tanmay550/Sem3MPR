...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.SQLite.pas' rev: 35.00 (Windows)
...
struct TFDSQLiteSecurityHelper /* Helper for class 'TFDSQLiteSecurity*' */;
...
__published:
	...
	__property System::UnicodeString SEEKey = {read=FSEEKey, write=FSEEKey};
public:
