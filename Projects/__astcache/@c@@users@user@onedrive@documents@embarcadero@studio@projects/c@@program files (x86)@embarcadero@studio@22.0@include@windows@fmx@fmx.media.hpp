...
// (DO NOT EDIT: machine generated header) 'FMX.Media.pas' rev: 35.00 (Windows)
...
enum class DECLSPEC_DENUM TFocusMode : unsigned char { AutoFocus, ContinuousAutoFocus, Locked };

enum class DECLSPEC_DENUM TTorchMode : unsigned char { ModeOff, ModeOn, ModeAuto };
