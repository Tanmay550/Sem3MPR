...
// (DO NOT EDIT: machine generated header) 'FireDAC.Stan.Expr.pas' rev: 35.00 (Windows)
...
static const System::WideChar C_FD_FBool = (System::WideChar)(0x62);
...
extern DELPHI_PACKAGE TFDExpressionManager* __fastcall FDExpressionManager();
}	/* namespace Expr */
}	/* namespace Stan */
}	/* namespace Firedac */
