...
// (DO NOT EDIT: machine generated header) 'FireDAC.Phys.SQLiteWrapper.pas' rev: 35.00 (Windows)
...
enum DECLSPEC_DENUM TSQLiteEngineLinkage : unsigned int { slDefault, slStatic, slDynamic, slSEEStatic };
...
public:
	static System::StaticArray<TSQLiteLibClass, 4> GLibClasses;
	...
	Firedac::Phys::Sqlitecli::Tsqlite3_activate_see Fsqlite3_activate_see;
	Firedac::Phys::Sqlitecli::Tsqlite3_key Fsqlite3_key;
	Firedac::Phys::Sqlitecli::Tsqlite3_rekey Fsqlite3_rekey;
	...
	void __fastcall ActivateSEE(const System::UnicodeString AKey);
